    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-24 bg-white">
      ...
      <h1 className="text-3xl text-left font-bold mb-6">Imagine that the customer from Question 4 responds with the following email. “I&apos;m so frustrated. I&apos;ve been trying to make this work for hours and I just can&apos;t figure it out. It must be a platform issue so why don&apos;t you just fix it for me instead of asking me questions.” Write a reply to the customer addressing the concerns raised.</h1>
        ...
        <div className="text-left mb-8">
          ...
          <p className="text-base leading-relaxed mb-5">The customer is obviously very irritated. If this was becoming a repeated issue, I would immediately ensure that the account owner is aware. When renewal and NDR are the top priorities, it&apos;s important to assess where the customer is in their journey and ensure that they feel seen and heard. For instance, the first 90 days of a customer’s onboarding are typically very important and we need to make sure that we decrease time to value as much as possible so that they can be unblocked. With that said, it&apos;s also very important to teach someone to fish so that they are empowered to fix issues on their own in the future.</p>
